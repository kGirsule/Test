 ...
 * Sie regelt alles, was nur der Rouge können sollte
 *
 * @author Katharina Girsule
 * @version 31.5.2020
 */
public class Rouge extends Spielerklassen {

    /**
     * Subklasse Magier, implementiert die speziellen Fähigkeiten des Rouge
     ...
     */
    public Rouge(Field field, Position position, int hp, int movement, Ability ability1, Ability ability2, Ability ability3)  {
    ...
    public String descriptionAb1(){
        return super.descriptionAb1()+"\t"+" You can attack a single Target twice";
    }
    ...
    public String descriptionAb2(){
        return super.descriptionAb2() +"\t"+" Your next attack has double damage";
    }
    ...
    public String descriptionAb3(){
        return super.descriptionAb3()+"\t"+" The Rouge turns invisible and can only take damage from Area-Of-Affekt-Attacks";
    }
